 ...
 * @param oneLine Useful when showing stats of many players for compactness.
 */
//noinspection DuplicatedCode
class Stats(api: HypixelAPI, name: String, oneLine: Boolean = false) {
   ...
   */
  def printStats(): Unit = {
    firstLine(player, compact = oneLine)
    saveStat("HyLevel", try {
      ILeveling.getLevel(player.get("networkExp").getAsDouble).toInt
    } catch {
      case _: NullPointerException => 1
    })

    saveStat("AP", player.get("achievementPoints"))

    if (!oneLine) { // Add stuff you dont want to be included in oneLine/compact mode
    ...
    if (oneLine) {
      ...
      Utils.put(str.toString(), prefix = true)
    } else {
      Utils.breakLine()
  ...
  /**
   * Saves statistics value into the line buffer in key-value format.
   */
   ...
   */
  private def firstLine(player: JsonObject, game: String = "", guild: Boolean = false, compact: Boolean = false): Unit = {
  ...
  def printStats(game: String): Unit = {
    ...
    game.toLowerCase match {
      case "arc" | "arcade" =>
        ...
        firstLine(player, "Arcade", compact = oneLine)
      ...
      case "ab" | "arena" | "arenabrawl" =>
        ...
        firstLine(player, "Arena Brawl", compact = oneLine)
      ...
      case "wl" | "bg" | "warlords" | "battleground" =>
        ...
        firstLine(player, "Warlords", compact = oneLine)
      ...
      case "bw" | "bedwars" =>
        ...
        firstLine(player, "BedWars", compact = oneLine)
        saveStat("Level", achievements.get("bedwars_level"))
        saveStat("Wins", bw.get("wins_bedwars"))
        saveStat("Losses", bw.get("losses_bedwars"))
        saveStat("WS", bw.get("winstreak"))
        saveStat("FKills", bw.get("final_kills_bedwars"))
        saveStat("FDeaths", bw.get("final_deaths_bedwars"))

        if (!oneLine) { // not in compact or oneline mode
      ...
      case "bb" | "build" | "buildbattle" =>
        ...
        firstLine(player, "Build Battle", compact = oneLine)
      ...
      case "duels" =>
        ...
        firstLine(player, "Duels", compact = oneLine)
      ...
      case "tkr" | "turbo" | "turbokartracers" | "gingerbread" =>
        ...
        firstLine(player, "Turbo Kart Racers", compact = oneLine)
      ...
      case "blitz" | "bsg" | "sg" | "hg" | "hungergames" =>
        ...
        firstLine(player, "Blitz Survival Games", compact = oneLine)
      ...
      case "legacy" | "classic" | "classiclobby" =>
        ...
        firstLine(player, "Classic Lobby", compact = oneLine)
      ...
      case "cvc" | "cac" | "copsandcrims" | "mcgo" =>
        ...
        firstLine(player, "CVC", compact = oneLine)
      ...
      case "pb" | "paintball" =>
        ...
        firstLine(player, "Paintball", compact = oneLine)
      ...
      case "q" | "quake" | "quakecraft" =>
        ...
        firstLine(player, "Quake", compact = oneLine)
      ...
      case "sw" | "skywars" =>
        ...
        firstLine(player, "SkyWars", compact = oneLine)
      ...
      case "sc" | "skyclash" =>
        ...
        firstLine(player, "SkyClash", compact = oneLine)
      ...
      case "suhc" | "speed" | "speeduhc" =>
        ...
        firstLine(player, "Speed UHC", compact = oneLine)
      ...
      case "sh" | "smash" | "supersmash" | "smashheroes" =>
        ...
        firstLine(player, "Smash Heroes", compact = oneLine)
      ...
      case "tnt" | "tntgames" =>
        ...
        firstLine(player, "TNT Games", compact = oneLine)
      ...
      case "tc" | "cw" | "crazywalls" | "truecombat" =>
        ...
        firstLine(player, "Crazy Walls", compact = oneLine)
      ...
      case "uhc" =>
        ...
        firstLine(player, "UHC", compact = oneLine)
      ...
      case "vz" | "vampz" | "vampirez" =>
        ...
        firstLine(player, "VampireZ", compact = oneLine)
      ...
      case "walls" =>
        ...
        firstLine(player, "Walls", compact = oneLine)
      ...
      case "walls3" | "mw" | "mega" | "megawalls" =>
        ...
        firstLine(player, "Mega Walls", compact = oneLine)
      ...
      case "mm" | "murder" | "murdermystery" =>
        ...
        firstLine(player, "Murder Mystery", compact = oneLine)
      ...
      case "g" | "guild" =>
        ...
        firstLine(player, guild = true, compact = oneLine)
    ...
    if (b && !oneLine) Utils.breakLine()
    if (oneLine) {
      val str = new StringBuilder
      lines.foreach { it => str.append(it).append("\u00a7f").append(" ") }
      Utils.put(str.toString(), prefix = true)
    } else lines.foreach { it => Utils.put(it) }
  ...
  private def getGameStats(player: JsonObject, game: String): JsonObject = try {
    ...
    case _: Exception =>
      Utils.error(s"${player.get("displayname").getAsString} has no stats in $game", prefix = true)
      null
  }
}
